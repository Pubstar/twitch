    ...
    <div className="App">
      ...
      <main>
        ...
        <div className='rows-container'>
          <Row snapshot={snapshot_Fextralife} viewers="42.1k" name="Fextralife" profile_img={profile_Fextralife} title="!MOUNT 🔴NEW !DROPS🔴 ~ NECROMANCER WITH CAS" game="Diablo IV" tags={["DropsEnabled", "English"]} />
